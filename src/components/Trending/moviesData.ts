...
export const moviesData: Movie[] = [
    { src: BatmanBegins, title: 'Batman Begins', main: 'Christian Bale', runtime: '120m' },
    { src: Dune, title: 'Dune', main: 'Timothée Chalamet', runtime: '120m' },
    { src: Sing2, title: 'Sing 2', main: 'Matthew McConaughey', runtime: '120m' },
    { src: SpiderMan, title: 'Spider-Man: No Way Home', main: 'Tom Holland', runtime: '120m' },
    { src: TDKRises, title: 'The Dark Knight Rises', main: 'Christian Bale', runtime: '120m' },
